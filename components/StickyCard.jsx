          ...
          HEADLINES.map((headline, index) => {
            ...
            return (
              <motion.div
                ...
                className='sticky top-1/2 mx-auto flex rounded-xl border border-gray-200 shadow-lg shadow-black/30 dark:border-none dark:bg-gradient-45deg dark:from-transparent dark:to-[#A395F6]/30 dark:pl-[0.3px] dark:pt-[0.3px] md:w-8/12'
                key={index}
              >
