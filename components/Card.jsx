...
function Card({ children, classId, hoverActive }) {
  const className = [
    'w-full flex flex-col gap-4 p-4 text-start transition-all border dark:border-zinc-800 shadow-xl dark:shadow-black/40 duration-150 ease-in md:rounded-xl dark:backdrop-blur-sm dark:bg-gray-900/10',
