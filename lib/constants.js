...
export const PROJECTS = [
  {
    ...
    image: chatup,
    description:
      "Chat Up is a web app that provides built-in real-time translation that helps people to chat in any supported language. It can translate multiple languages in both single and group chats allowing everyone to easily communicate. It's built for both experimental purposes and to make life easier for small friend groups that have a language barrier.",
    builtWith: [
      'Next.js',
      'Typescript',
      'TailwindCSS',
  ...
  },
  {
    ...
    image: aybrkDev,
    description:
      'My personal website to showcase my knowledge, skills and share a little bit about my personal life. :)',
    builtWith: [
      'Next.js',
      'Shadcn/ui',
      'TailwindCSS',
